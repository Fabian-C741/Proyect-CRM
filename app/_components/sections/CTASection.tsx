...
export default function CTASection({ ctaTitle, ctaText, ctaButtonText, whatsappNumber }: Props) {
  return (
    <motion.section
      ...
      style={{ width: '100%', maxWidth: 700, margin: '0 auto 6rem' }}
    >
      <motion.div
      ...
      >
        <h2 style={{ fontSize: '1.75rem', fontWeight: 700, marginBottom: '1rem' }}>{ctaTitle}</h2>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', lineHeight: 1.6 }}>
          {ctaText}
        </p>
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <Link
            href={`https://wa.me/${whatsappNumber}?text=Hola! Me gustaría reservar un turno`}
            target="_blank"
