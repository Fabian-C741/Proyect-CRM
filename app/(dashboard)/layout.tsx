...
import { contarPendientes } from '@/lib/dal/pedidos'
...
const navItems = [
  ...
  { name: 'Ventas', href: '/dashboard/ventas', icon: 'M3 3h18v4H3zM3 10h18v11H3z M7 14h2 M11 14h2 M15 14h2' },
...
export default async function DashboardLayout({
  ...
  const pendientesManuales = await contarPendientes(user.id)
  const navItemsConBadge = navItems.map(i =>
    i.name === 'Ventas' ? { ...i, badge: pendientesManuales } : i
  )
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-surface-950">
      ...
      <meta name="apple-mobile-web-app-capable" content="yes" />
        <Sidebar brandName={brandName} navItems={navItemsConBadge} />
